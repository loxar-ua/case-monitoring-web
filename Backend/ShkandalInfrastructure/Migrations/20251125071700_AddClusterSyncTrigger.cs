...
{
    /// <inheritdoc />
    public partial class AddClusterSyncTrigger : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                CREATE OR REPLACE TRIGGER tr_maintain_cluster_dates
            ...
            migrationBuilder.Sql("""
                CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_article_cluster_calc_part
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            """);
            migrationBuilder.Sql("""
                DROP INDEX CONCURRENTLY IF EXISTS idx_article_cluster_calc_part;
            """, suppressTransaction: true);
        }
    }
}